...
matplotlib.use('agg')
cap = cv2.VideoCapture(r"C:\Users\91827\Desktop\Capstone\30seconds_clip.mp4")
...
f_w, f_h, fps = (int(cap.get(x)) for x in (640,480, cv2.CAP_PROP_FPS))

frame_data = {'width': f_w, 'height': f_h}
